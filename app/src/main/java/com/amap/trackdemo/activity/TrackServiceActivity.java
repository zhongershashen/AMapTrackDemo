...
//    private EditText upload;
    ...
    private int locateFrequency = 2;
    private int uploadFrequency = 10;
...
//  接收猎鹰sdk服务启停状态的监听器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aMapTrackClient.setInterval(locateFrequency, uploadFrequency);
//
...
//        locate = findViewById(R.id.locateNumber);
//        upload = findViewById(R.id.uploadNumber);
        updateBtnStatus();
        // 服务启停
...
//                    locateFrequency = Integer.parseInt(locate.getText().toString());
//                    uploadFrequency = Integer.parseInt(upload.getText().toString());
//                    aMapTrackClient.setInterval(locateFrequency, uploadFrequency);
                    startTrack();
                }
            }
        ...
        startGatherView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isGatherRunning) {
                    ...
                    System.out.println("aaaaaaaaaaaaaaaaaaaaaa"+trackId);
...
//        locate.setFocusable(!isServiceRunning);
//        upload.setFocusable(!isServiceRunning);
        setWindowBrightness(isGatherRunning?0:255);
    }
            ...
            public void run() {
                try {
                    RequestBody requestBody = new FormBody.Builder()
                            .add("terminalName",Constants.TERMINAL_NAME)
                            .add("terminalId",Long.toString(terminalId))
                            .add("trackId",Long.toString(trackId))
                            .build();
